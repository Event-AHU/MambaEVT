    ...
    def update_settings(self, settings=None):
        ...
        if self.settings.env.workspace_dir is not None:
            ...
            if self.settings.save_dir is None:
                ...
                self._checkpoint_dir = os.path.join(self.settings.save_dir, 'mamba_checkpoints')
        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    save_epochs = [5, 8, 45, 159, 239]
                    if epoch > (max_epochs - 1) or save_every_epoch or epoch % 10 == 0 or epoch in save_epochs or epoch > (max_epochs - 2):
