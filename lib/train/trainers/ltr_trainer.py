...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        print("Epoch Time: " + str(datetime.timedelta(seconds=epoch_time)), flush=True)
        print("Avg Data Time: %.5f" % (self.avg_date_time / self.num_frames * batch_size), flush=True)
        print("Avg GPU Trans Time: %.5f" % (self.avg_gpu_trans_time / self.num_frames * batch_size), flush=True)
        print("Avg Forward Time: %.5f" % (self.avg_forward_time / self.num_frames * batch_size), flush=True)
