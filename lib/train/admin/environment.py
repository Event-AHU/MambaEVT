...
def create_default_local_file():
    ...
    default_settings = OrderedDict({
        ...
        'eventvot_dir': empty_str,
        'eventvot_val_dir': empty_str
    })
...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'eventvot_dir' : os.path.join(workspace_dir, 'data/EventVOT/train'),
        'eventvot_val_dir': os.path.join(workspace_dir, 'data/EventVOT/val')
    })
